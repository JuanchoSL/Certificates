...
class Certificates
{
    ...
    public function setCa(PrivateKeyReadableInterface&CertificateReadableInterface&ChainReadableInterface $ca)
    {
        $this->ca = $ca;
    }
    ...
    public function createSigningRequest(array $dn, PrivateKeyContainer &$privkey, ?array $config = null, ?string $passphrase = null): \OpenSSLCertificateSigningRequest
    {
